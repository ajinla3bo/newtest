...
→ | عدد السيرفرات الحاليه : \`${client.guilds.size}\`**`)
        .setColor('RANDOM')
client.guilds.get('555471569002954775').channels.get('557296432932061215').send(embed)
}); 
...
client.login('NTU2NTU1NzAwOTQ0NTAyODA0.D3GU-g.vl3uUmEYRtVzD2neOdbc2fY2qk8');